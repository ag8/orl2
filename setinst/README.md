...
### 8. Lower Batch Size Configuration (for OOM issues)

If you're experiencing out-of-memory (OOM) errors, use this configuration with reduced batch sizes:
...
--flash_attn \
--gradient_checkpointing \
--remote_rm_url /root/orl2/steg_rewarder.py \
--use_wandb 6a7e6c36b9bc885d48cb355afb10998284b9e8ef
```
...
--colocate_actor_ref \
--pretrain Qwen/Qwen2.5-7B-Instruct \
--save_path /root/orl2/openrlhf/examples/checkpoint/qwen7b_8gpu \
--save_steps 10 \
